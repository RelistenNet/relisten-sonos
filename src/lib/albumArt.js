function drawRelistenAlbumArt(canvas, data, targetFrame, resizing) {
    ...
    context.font = 'bold 72px Arial-BoldMT, Arial, "Helvetica Neue", Helvetica, sans-serif';
    ...
    context.fillStyle = textForeground;
    context.font = 'bold 140px Arial-BoldMT, Arial, "Helvetica Neue", Helvetica, sans-serif';
    ...
    context.fillStyle = textForeground;
    context.font = '100px ArialMT, Arial, "Helvetica Neue", Helvetica, sans-serif';
    context.textAlign = 'center';
